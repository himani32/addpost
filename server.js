...
* 
*  Name: ___Himani___________________ Student ID: _______155567217_______ Date: ___11/04/2022_____________
*
...
app.post("/views/addPost", upload.single("featureImage"), (req, res) => {
  if (req.file) {
